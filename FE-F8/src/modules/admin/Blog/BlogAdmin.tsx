...
import CreateEditBlog from './CreateEditBlog/CreateEditBlog';

export interface BlogAdminProps {}

export default function BlogAdmin(props: BlogAdminProps) {
      ...
      <Box p="20px">
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb="40px">
          ...
          <Stack width="75%" gap="30px" direction="row" alignItems="center">
            ...
            <Box width="70%">
              <TextField id="outlined-basic" size="small" label="Search by name blog" variant="outlined" fullWidth />
            </Box>
          </Stack>
        </Stack>
      </Box>

      <CreateEditBlog close={handleCloseDialog} isOpen={isOpen} />
    </>
  );
}
